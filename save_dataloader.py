...
if __name__ == '__main__':
    ...
    parser.add_argument('--yaml_config', type=str, default='/workspace/Fake-News-Detection-Dataset/part1_title/configs-direct/ngram_title_category_select/RoBERTa/RoBERTa_save_dataloader.yaml', help='exp config file')
