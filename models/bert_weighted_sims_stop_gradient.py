...
class BERT_Weighted_Sims_Stop_Gradient(BertPreTrainedModel):
...
@register_model
def bert_weighted_sims_stop_gradient(hparams: dict, **kwargs):
    model_config = AutoConfig.from_pretrained(hparams['pretrained_name'])
    model = BERT_Weighted_Sims_Stop_Gradient(
