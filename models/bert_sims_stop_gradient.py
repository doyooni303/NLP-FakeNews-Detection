...
class BERT_Sims_Stop_Gradient(BertPreTrainedModel):
    ...
    def forward(
        ...
        # content_representations = content_representations.detach()
...
@register_model
def bert_sims_stop_gradient(hparams: dict, **kwargs):
    model_config = AutoConfig.from_pretrained(hparams['pretrained_name'])
    model = BERT_Sims_Stop_Gradient(
